...
> the program runs over and over again

Why?
> because the guess is not being updated so the while loop is alwasy checking if the guess is equal to my_num. Since this will always be true the body comes forever
